...
class DefaultProgressbarSkin:
    ...
    def load(self, player: LavalinkPlayer) -> dict:
        ...
        data["components"] = [
            ...
            disnake.ui.Button(emoji="<:pnv_cong1:1167732512336920606>", custom_id=PlayerControls.add_song, style=disnake.ButtonStyle.green, label="音楽を追加する", disabled= True if player.paused else False),
            disnake.ui.Select(
                placeholder="別の選択肢:",
