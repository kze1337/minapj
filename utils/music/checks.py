...
async def check_pool_bots(inter, only_voiced: bool = False, check_player: bool = True, return_first=False):
    ...
    if not bot_in_guild:
        ...
        if bot_missing_perms:
            msg = f"**Có các bot âm nhạc có sẵn trên máy chủ nhưng chúng không được phép gửi tin nhắn trên kênh <#{inter.channel_id}>**:\n\n" + \
        ...
        if extra_bots_counter:
            if inter.author.guild_permissions.manage_guild:
                msg += "\n\n**Hoặc nếu bạn thích: Thêm nhiều bot âm nhạc hơn vào máy chủ hiện tại bằng cách nhấp vào nút bên dưới:**"
            else:
            ...
            components = [disnake.ui.Button(custom_id="bot_invite", label="Thêm nhiều bot âm nhạc bằng cách nhấp vào đây")]
